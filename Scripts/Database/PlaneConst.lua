...
PlaneConst = 
{
	...
	[3] = --su-27, Ñó-27Ñ
	{
		...
		--[[
			...
			Íîñîâàÿ ñòîéêà (-2,289m...-1,992m)
			Îñíîâíûå (-2,555m...-2,123m)
		--]]	
	...
	[4] = --su-33, Ñó-33
	{
		...
		radar_can_see_ground	=	true,
			...
			--[[
		Êîîğäèíàòà òî÷êè êàñàíèÿ ïğè íîğìàëüíîì îáæàòèè -2.16
		íåîáæàòàÿ            -2.33
		ïîëíîñòüş îáæàòà     -1.74
		Äëÿ îñíîâíûõ:
		íîğìàëüíîå îáæàòèå -2.17
		íåîáæàòà  		   -2.55
		ïîëíîñòüş îáæàòà   -2.06
		--]]	
	...
	[6] = --f-15
	{
		...
		--[[
		Ô-15 
		Íîñîâàÿ ñòîéêà (-2.523m...-2.093m)
		Îñíîâíûå	   (-2.456m...-2.228m)
		--]]
	...
	[12] = --su-24, Ñó-24Ì
	{
		...
		brakeshute_name	=	4,
		is_tanker	=	false,
		air_refuel_receptacle_pos = 	{9.143,	1.142,	0},
		fires_pos = 
		{
			[1] = 	{-0.936,	-0.861,	0},
			[2] = 	{-0.454,	0.556,	1.272},
	...
	[20] = --su-34, Ñó-34
	{
		...
		has_afteburner	=	true,
		has_speedbrake	=	false,
		main_gear_pos = 	{-0.77,	-2.724,	2.151},
		radar_can_see_ground	=	true,
		nose_gear_pos = 	{6.723,	-2.698,	0},
		AOA_take_off	=	0.14,
		stores_number	=	12,
		bank_angle_max	=	60,
		Ny_min	=	-3,
	...
	[41] = --e-2
	{
		...
		has_speedbrake	=	false,
		has_differential_stabilizer = false,
		main_gear_pos = 	{-0.638,	-1.941,	3.016},
		radar_can_see_ground	=	true,
		nose_gear_pos = 	{6.514,	-2.302,	0},
		AOA_take_off	=	0.14,
		stores_number	=	0,
		bank_angle_max	=	45,
		Ny_min	=	0,
	...
	[50] = --mig-29c, ÌèÃ-29Ñ
	{
		...
		wing_area	=	38.1,
		wing_span	=	11.36,
		thrust_sum_max	=	101600,
		thrust_sum_ab	=	166800,
		Vy_max	=	330,
		length	=	20.32,
		height	=	4.73,
		flaps_maneuver	=	1,
	...
	[62] = --p-51b
	{
		...
		has_speedbrake	=	false,
		has_differential_stabilizer = false,
		main_gear_pos = 	{ 0.016, -1.957, 1.776},
		radar_can_see_ground	=	false,
		nose_gear_pos = 	{-5.014, -0.807,	0},
		AOA_take_off	=	0.14,
		stores_number	=	11,
		bank_angle_max	=	60,
		Ny_min	=	-4,
	...
	[63] = --p-51d
	{
		...
		has_speedbrake	=	false,
		has_differential_stabilizer = false,
		--main_gear_pos = 	{ 0.03, -2.157, 1.779},
		main_gear_pos = 	{ 0.03, -2.1, 1.779},
		radar_can_see_ground	=	false,
		--nose_gear_pos = 	{-4.99, -0.879,	0},
		nose_gear_pos = 	{-4.99, -0.92,	0},
		AOA_take_off	=	0.14,
		stores_number	=	11,
		bank_angle_max	=	60,
		Ny_min	=	-4,
