return plane( "MiG-29S", _("MiG-29S"),
    {
        ...
        passivCounterm = {
            CMDS_Edit = true,
            SingleChargeTotal = 600000,
            -- PPR-26
            chaff = {default = 3000, increment = 30, chargeSz = 1},
            -- MJU-7
            flare = {default = 3000, increment = 30, chargeSz = 1}
        },
        ...
        Failures = {
            { id = 'asc',       label = _('ASC'),       enable = false, hh = 0, mm = 0, mmint = 1, prob = 0 },
            { id = 'autopilot', label = _('AUTOPILOT'), enable = false, hh = 0, mm = 0, mmint = 1, prob = 100 },
            { id = 'hydro',     label = _('HYDRO'),     enable = false, hh = 0, mm = 0, mmint = 1, prob = 100 },
            { id = 'l_engine',  label = _('L-ENGINE'),  enable = false, hh = 0, mm = 0, mmint = 1, prob = 0 },
            { id = 'r_engine',  label = _('R-ENGINE'),  enable = false, hh = 0, mm = 0, mmint = 1, prob = 0 },
    ...
    },
    {
        ...
        pylon(4, 1, -0.783000, -0.150000, 0.000000,
            {
            },
            {
